    ...
    <div id="nav">
      ...
      >
        <Stack direction="row" className="w-[100%] justify-between">
          <Stack
            direction="row"
            className="items-center justify-between transition-all text-white mx-3 gap-3  w-[30%] "
          >
          ...
          <Stack
            direction="row"
            className="transition-all items-center justify-between w-[30%] max-sm:w-[100%]"
          >
